...
<template>
  ...
  >
    <div
      class="showcase_glow absolute -z-10 aspect-video w-full max-w-2xl rounded-full bg-sky-700 blur-[120px] filter mix-blend-screen"
    />
    <PrismicRichText
      :field="slice.primary.heading"
      wrapper="header"
      class="showcase_heading text-balance text-center text-5xl font-medium md:text-7xl"
    />
    <article
