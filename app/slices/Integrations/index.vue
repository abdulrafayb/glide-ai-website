...
<template>
  ...
  >
    ...
    />
    <GlideLogoFrame
      class="absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 scale-150 opacity-60"
    />
    <GlideLogoFrame
    ...
    <div class="relative">
      <PrismicText
        ...
        wrapper="h2"
        class="mx-auto max-w-2xl text-balance bg-gradient-to-b from-sky-50 to bg-sky-300 bg-clip-text text-transparent py-2 text-center text-5xl md:text-7xl font-medium"
      />
      <PrismicRichText
